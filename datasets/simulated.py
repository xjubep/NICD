...
class SIMULATED(Dataset):
    def __init__(self, args, num_negatives=None, triplet_csv=None, train_csv=None, test_csv=None,
        ...
        if self.mode == 'train_triplet':
            ...
            self.neg_paths = glob(f'/mldisk/nfs_shared_/MLVD/DISC/images/train/*')
    ...
    def load_image_flip(self, path):
        ...
        return path, img1['image'], img2['image']
